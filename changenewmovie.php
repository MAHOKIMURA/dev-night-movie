        ...
        <nav class="navbar navbar-dark navbar-expand-lg navbar-togglerable-md">
          <div class="container">
            ...
            <ul class="navbar-nav collapse navbar-collapse" id="basicNav">
              <li class="nav-item">
                <a href="movie_info.admin.php" class="nav-link">Back to Infomation History</a>
              </li>
              <li class="nav-item">
    ...
    <div class="card w-75 mx-auto">
      ...
      <div class="card-body">
        <form action="nightmovieAction.php" method="post">
          ...
          <br>
          <br>
          <button type="submit" name="changenew" class="btn btn-outline-info btn-block">Change New Movie Infomation</button>
        </form>
      </div>
    </div> 
